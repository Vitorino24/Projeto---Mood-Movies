...
app = Flask(__name__)
CORS(app)
gemini.configure(api_key="sua chave vai aqui S2")
...
def make_():
    try:
        ...
        O nome do filme deve ser um link amarelo, o nome da série deve ser um link rosa(a cor desse rosa deve ser bem escuro) e o infantil um link azul de uma pesquisa do google que mostre o filme ou serie(nesse link você precisa colocar o nome do conteudo e após o que ele é filme ou série)
        """
